...
```json
{
  ...
  "paths": {
    "/v2/chats/contact/{contactId}": {
      "get": {
        "summary": "List chats by contact",
        "tags": [
          "Chats"
        ],
        "description": "Retrieve a paginated list of chats for a specific contact. Results are sorted by last_message_at descending.",
        "servers": [
          {
              ...
              "application/json": {
                "schema": {
                  ...
                  "properties": {
                    ...
                    "message": {
                      "type": "string",
                      "example": "Param contact_id must be a valid UUID"
                    }
                  }
                }
              }
